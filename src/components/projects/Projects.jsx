...
import CodeSymbols from '../utils/CodeSymbols'

const Projects = forwardRef(({ projectsToShow, allProjects }, ref) => {
    const openModal = useUiStore((state) => state.openModal)
    return(
        
            <AnimatedSection ref={ref} id="projects" className='relative'>
                <CodeSymbols />
                <h2 className='text-3xl font-bold text-center text-neutral-100 sm:text-4xl relative z-10'>Proyectos</h2>

                <div className='mt-12 grid gap-8 md:grid-cols-2 lg:grid-cols-3 relative z-10'>
